...
module Indexed.Profunctor.Product {ℓ : Level} {I : Set} where

unit : Profunctor ℓ I
unit = LiftP ℓ (constant ⊤)

bang-unit : ∀ {ℓ'} {P : Profunctor ℓ' I}
  → P ⇒ unit
bang-unit .φ = λ _ → lift tt
bang-unit .naturality = irr[( λ _ _ _ → ≡.refl )]

bang-unit-univ : ∀ {ℓ'} {P : Profunctor ℓ' I}
